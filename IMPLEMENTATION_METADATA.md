...
- [x] `metadataBase` — set to the real production URL (`https://lumiere-medical-spa-alpha.vercel.app`), required for relative image paths in `openGraph`/`twitter` to resolve to absolute URLs
