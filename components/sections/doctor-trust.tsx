        ...
        */}
        <div className="mt-5 sm:mt-10 lg:grid lg:grid-cols-[55fr_45fr] lg:items-stretch lg:gap-8">
          ...
          <Reveal className="order-2 lg:order-2 lg:flex lg:items-center">
            <RevealItem className="mx-auto mt-5 max-w-2xl text-center text-[0.7rem] leading-snug text-pretty text-muted-foreground sm:mt-10 sm:text-2xl sm:leading-relaxed lg:mx-0 lg:mt-0 lg:max-w-none lg:text-left">
              <p>
