            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="text-[0.75rem] font-medium leading-tight text-foreground sm:font-serif sm:text-xl">
                    {card.title}
                  </h3>
                  <p className="mt-1 text-[0.65rem] leading-snug text-muted-foreground sm:mt-1.5 sm:text-base sm:leading-relaxed">
                    {card.body}
                  </p>
                </div>
              </RevealItem>
