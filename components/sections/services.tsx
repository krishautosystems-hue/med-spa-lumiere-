              ...
              >
                ...
                <div className="flex w-full flex-row gap-3 sm:gap-6">
                  ...
                  <div className="flex w-1/2 min-w-0 flex-col">
                    ...
                    <div className="mt-2 flex items-center gap-2 text-[0.65rem] font-medium text-accent sm:mt-3 sm:gap-3 sm:text-sm">
                      <span>{service.price}</span>
                      <span className="text-border">•</span>
                      <span className="text-muted-foreground">{service.duration}</span>
                    </div>
                    <p className="mt-2 text-[0.65rem] leading-snug text-muted-foreground sm:mt-3 sm:text-lg sm:leading-relaxed">
                      {service.description}
                    </p>
                ...
                <AnimatePresence initial={false}>
                  {open && (
                    ...
                    >
                      ...
                      <div className="mt-2 flex flex-col gap-2 border-t border-border pt-2 text-[0.65rem] sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:gap-y-0 sm:pt-5 sm:text-sm">
                        <div>
